...
<div x-data="setup()" :class="{ 'dark': isDark }">
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
      <tr class="hover:bg-teal-100">
        ...
        <td class="px-6 py-4">
          <img class="flex-none w-40 relative" src="<?= base_url('assets/img/produk/1.jpg') ?>" alt="image" />
        </td>
        <td class="px-6 py-4">Striped Cardigan</td>
        <td class="px-6 py-4">Rp 75.000</td>
        <td class="px-6 py-4">
          <span
      ...
      <tr class="hover:bg-teal-100">
        ...
        <td class="px-6 py-4">
          <img class="flex-none w-40 relative" src="<?= base_url('assets/img/produk/2.jpg') ?>" alt="image" />
        </td>
        <td class="px-6 py-4">Black Shirt</td>
