...
<div x-data="setup()" :class="{ 'dark': isDark }">
    ...
    <div class="flex flex flex-col items-center lg:items-start justify-center px-8 mt-2">
        <div class="flex items-center space-x-2 mt-2">
            <a href="<?= base_url('/admin/add_admin') ?>" type="button" class="flex items-center bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
