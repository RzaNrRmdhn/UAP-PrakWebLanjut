...
<body>
    ...
    <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            <div class="absolute inset-0 bg-gradient-to-r from-emerald-300 to-emerald-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
            </div>
                            ...
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="mt-7 text-center text-gray-300 text-xs">
                                    <p class="text-gray-400">have an account?
                                        <a href="<?php echo base_url('customer/signin') ?>" class="font-bold text-black hover:text-blue-700">Sign In</a>
                                    </p>
                                </div>
                            </div>
                        </div>
