            ...
            <form action="<?= base_url('/customer/buy') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class=" md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
                    ...
                    <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                        <img class="w-full" alt="image of a girl posing" src="<?= $barang['image'] ?>" />
                    </div>
                    <div class="md:hidden">
                    ...
                    <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                        ...
                        <div class="py-4 border-b border-gray-200 flex items-center justify-between">
                            <p class="text-base leading-4 text-gray-800 dark:text-gray-300">Harga</p>
                            <div class="flex items-center justify-center">
                                <p class="text-sm leading-none text-gray-600 dark:text-gray-300 mr-3">Rp<?= $barang['harga_barang'] ?></p>
                        ...
                        <input type="text" name="nama" value="<?= $barang['nama_barang'] ?>" hidden>
                        ...
                        <div>
                            <p class="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 dark:text-gray-300 mt-7"><?= $barang['deskripsi_barang'] ?></p>
                        </div>
                        <div>
